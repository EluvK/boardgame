...
const BOARD_MAX_COL: i32 = 12;
const BOARD_MAX_ROW: i32 = 9;
...
impl AcquireState {
    ...
    fn first_inactive_company(&self) -> Option<String> {
        for id in COMPANY_IDS {
    ...
    fn set_share_count(&mut self, user: &str, company: &str, count: i64) {
        let c = count.max(0);
        self.shares
            .entry(user.to_string())
            .or_default()
